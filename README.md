# Ir-Servo-Control
Projet Arduino réalisé en simulation, permettant de piloter un servo-moteur en aller-retour entre la position 0° et la valeur saisie via une télécommande.
